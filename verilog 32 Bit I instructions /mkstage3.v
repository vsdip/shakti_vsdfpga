...
module mkstage3(CLK,
  ...
  reg [63 : 0] v__h5485;
  reg rg_rerun_04_AND_TASK_testplusargs_24_OR_TASK_t_ETC___d129;
  reg ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d139;
  reg wr_memory_response_69_BIT_1_74_AND_TASK_testpl_ETC___d209;
  reg NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d213;
  reg NOT_wr_memory_response_69_BIT_34_70_21_OR_NOT__ETC___d233;
  reg NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d236;
  ...
  reg NOT_rg_epoch_06_EQ_IF_ff_stage3_common_w_data__ETC___d244;
  // synopsys translate_on

  // remaining internal signals
  wire [102 : 0] _dfoo2,
		 csr_mv_curr_priv__52_CONCAT_ff_stage3_dump_w_d_ETC___d191;
  wire [37 : 0] _dfoo10;
  wire [32 : 0] _dfoo14;
  wire [31 : 0] _theResult____h3889,
		_theResult____h4529,
		_theResult____h4842,
		x__read_rdvalue__h6271;
  wire [5 : 0] rx_stage3_type_first_x_BITS_37_TO_32__q1, type_cause__h4912;
  wire [4 : 0] x__read_rdaddr__h6270;
  wire NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d157,
       _dfoo11,
       _dfoo15,
       _dfoo17,
       _dfoo25,
       ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d198,
       ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d225,
       rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107,
       rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d110,
       rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d133,
       rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d146,
       rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d155,
       rg_rerun_04_OR_ff_stage3_type_w_data_whas__4_A_ETC___d109,
       rg_rerun_04_OR_ff_stage3_type_w_data_whas__4_A_ETC___d120,
       wr_memory_response_69_BIT_0_71_EQ_rg_epoch_06___d172,
       x__h5193,
       x_wget__h1860;
  ...
  // value method mv_event_exceptions
  assign mv_event_exceptions = wr_event_exceptions_whas && x_wget__h1860 ;
  ...
  assign wr_operand_fwding_wget =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d146 ?
	       { rx_stage3_common_first_x[5:1], _theResult____h3889, 1'd1 } :
	       { rx_stage3_common_first_x[5:1], _theResult____h4842, 1'd1 } ;
  assign wr_operand_fwding_whas = WILL_FIRE_RL_instruction_commit && _dfoo25 ;
  assign wr_commit_wget =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d146 ?
	       { 1'd1, rx_stage3_common_first_x[5:1], _theResult____h3889 } :
	       _dfoo10 ;
  ...
  // remaining internal signals
  assign NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d157 =
	     !rg_rerun && rx_stage3_type_first_x[50:49] == 2'd3 &&
	     csr_system_instruction[64] ;
  assign _dfoo10 =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d155 ?
	       { 1'd1, rx_stage3_common_first_x[5:1], _theResult____h4529 } :
	       ((rx_stage3_type_first_x[35:34] == 2'd3) ?
		  38'h2000000000 :
		  { 1'd1,
		    rx_stage3_common_first_x[5:1],
  ...
  assign _dfoo11 =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
	     (NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d157 ||
	      !rg_rerun &&
	      ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d198) ;
  assign _dfoo14 =
	     (rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
  ...
  assign _dfoo25 =
	     ...
	     wr_memory_response_69_BIT_0_71_EQ_rg_epoch_06___d172 &&
	     !wr_memory_response[1] ;
  assign _theResult____h3889 =
	     (rx_stage3_common_first_x[5:1] == 5'd0) ?
	       32'd0 :
	       rx_stage3_type_first_x[31:0] ;
  assign _theResult____h4529 =
	     (rx_stage3_common_first_x[5:1] == 5'd0) ?
	       32'd0 :
	       csr_system_instruction[31:0] ;
  assign _theResult____h4842 =
	     (rx_stage3_common_first_x[5:1] == 5'd0) ?
	       32'd0 :
	       wr_memory_response[33:2] ;
  assign csr_mv_curr_priv__52_CONCAT_ff_stage3_dump_w_d_ETC___d191 =
	     { csr_mv_curr_priv,
	       rx_stage3_dump_first_x,
	       (rx_stage3_type_first_x[35:34] == 2'd3) ?
		 37'd0 :
		 { rx_stage3_common_first_x[5:1], _theResult____h4842 } } ;
  assign ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d198 =
	     rx_stage3_type_first_x[50:49] == 2'd0 &&
	     rx_stage3_type_first_x[35:34] != 2'd3 &&
	     wr_memory_response[34] &&
	     wr_memory_response_69_BIT_0_71_EQ_rg_epoch_06___d172 &&
	     wr_memory_response[1] ;
  assign ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d225 =
	     rx_stage3_type_first_x[50:49] == 2'd0 &&
	     rx_stage3_type_first_x[35:34] != 2'd3 &&
	     (!wr_memory_response[34] ||
	      !wr_memory_response_69_BIT_0_71_EQ_rg_epoch_06___d172) ;
  assign rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 =
	     rg_epoch == rx_stage3_common_first_x[0] ;
  assign rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d110 =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
	     (rg_rerun || rx_stage3_type_first_x[50:49] == 2'd1) ;
  assign rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d133 =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
	     !rg_rerun &&
	     rx_stage3_type_first_x[50:49] == 2'd1 ;
  assign rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d146 =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
	     !rg_rerun &&
	     rx_stage3_type_first_x[50:49] == 2'd2 ;
  assign rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d155 =
	     rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
	     !rg_rerun &&
	     rx_stage3_type_first_x[50:49] == 2'd3 ;
  assign rg_rerun_04_OR_ff_stage3_type_w_data_whas__4_A_ETC___d109 =
	     rg_rerun || rx_stage3_type_first_x[50:49] == 2'd1 ||
	     !rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 ;
  assign rg_rerun_04_OR_ff_stage3_type_w_data_whas__4_A_ETC___d120 =
	     rg_rerun ||
	     rx_stage3_type_first_x[50:49] == 2'd3 &&
	     !csr_system_instruction[64] ;
  assign rx_stage3_type_first_x_BITS_37_TO_32__q1 =
	     rx_stage3_type_first_x[37:32] ;
  assign type_cause__h4912 =
	     (rx_stage3_type_first_x[35:34] == 2'd0) ? 6'd5 : 6'd7 ;
  assign wr_memory_response_69_BIT_0_71_EQ_rg_epoch_06___d172 =
	     wr_memory_response[0] == rg_epoch ;
  assign x__h5193 = ~rg_epoch ;
  assign x__read_rdaddr__h6270 =
	     wr_operand_fwding_whas ? wr_operand_fwding_wget[37:33] : 5'd0 ;
  assign x__read_rdvalue__h6271 =
	     wr_operand_fwding_whas ? wr_operand_fwding_wget[32:1] : 32'd0 ;
  assign x_wget__h1860 = ~rx_stage3_type_first_x_BITS_37_TO_32__q1[5] ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_rerun)
	begin
	  TASK_testplusargs___d124 = $test$plusargs("fullverbose");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
	  ...
	  rg_rerun)
	begin
	  TASK_testplusargs___d125 = $test$plusargs("mstage3");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
	  ...
	  rg_rerun)
	begin
	  TASK_testplusargs___d126 = $test$plusargs("l0");
	  #0;
	end
    rg_rerun_04_AND_TASK_testplusargs_24_OR_TASK_t_ETC___d129 =
	rg_rerun &&
	(TASK_testplusargs___d124 ||
	 TASK_testplusargs___d125 && TASK_testplusargs___d126);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
	  rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
	  rg_rerun)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d133)
	begin
	  TASK_testplusargs___d135 = $test$plusargs("mstage3");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
    ...
    ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d139 =
	rx_stage3_type_first_x[50:49] == 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d198)
	begin
	  TASK_testplusargs___d205 = $test$plusargs("mstage3");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
    ...
    wr_memory_response_69_BIT_1_74_AND_TASK_testpl_ETC___d209 =
	wr_memory_response[1] &&
	(TASK_testplusargs___d204 ||
	 TASK_testplusargs___d205 && TASK_testplusargs___d206);
    NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d213 =
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d225)
	begin
	  TASK_testplusargs___d228 = $test$plusargs("fullverbose");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
	  ...
	  ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d225)
	begin
	  TASK_testplusargs___d229 = $test$plusargs("mstage3");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
	  ...
	  ff_stage3_type_w_data_whas__4_AND_ff_stage3_ty_ETC___d225)
	begin
	  TASK_testplusargs___d230 = $test$plusargs("l1");
	  #0;
	end
    NOT_wr_memory_response_69_BIT_34_70_21_OR_NOT__ETC___d233 =
	(!wr_memory_response[34] ||
	 !wr_memory_response_69_BIT_0_71_EQ_rg_epoch_06___d172) &&
	(TASK_testplusargs___d228 ||
	 TASK_testplusargs___d229 && TASK_testplusargs___d230);
    NOT_rg_rerun_04_22_AND_ff_stage3_type_w_data_w_ETC___d236 =
	!rg_rerun && rx_stage3_type_first_x[50:49] == 2'd0 &&
	rx_stage3_type_first_x[35:34] != 2'd3 &&
	NOT_wr_memory_response_69_BIT_34_70_21_OR_NOT__ETC___d233;
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107)
	begin
	  TASK_testplusargs___d240 = $test$plusargs("mstage3");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_instruction_commit &&
    ...
    NOT_rg_epoch_06_EQ_IF_ff_stage3_common_w_data__ETC___d244 =
	!rg_epoch_06_EQ_IF_ff_stage3_common_w_data_whas_ETC___d107 &&
