...
//
// On Mon Mar 31 00:26:10 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkcsrfile(CLK,
  ...
  reg [63 : 0] v__h16872;
  reg TASK_testplusargs___d938;
  reg TASK_testplusargs___d939;
  ...
  reg [63 : 0] v__h6987;
  reg TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d923;
  reg TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d925;
  reg TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d934;
  reg TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d937;
  // synopsys translate_on

  // remaining internal signals
  reg [31 : 0] data___1__h4214, data___1__h4412;
  ...
  wire [31 : 0] IF_SEL_ARR_v_trig_tdata1_0_2_BITS_19_TO_18_3_E_ETC___d183,
		...
		data___1__h6663,
		data___1__h6688;
  wire [30 : 0] IF_upd_on_ret_prv_EQ_0_83_THEN_IF_misa_c_62_TH_ETC___d892,
		result__h12816,
		result__h12955;
  wire [29 : 0] IF_rg_mode_56_EQ_1_51_AND_upd_on_trap_cause_BI_ETC___d954,
		IF_rg_umode_45_EQ_1_46_AND_upd_on_trap_cause_B_ETC___d950;
  ...
  wire [8 : 0] rg_ueie_49_AND_misa_n_15_AND_soft_ueip_11_OR_e_ETC___d982;
  wire [7 : 0] x__h5501;
  wire [6 : 0] _0_CONCAT_rg_utie_52_AND_misa_n_15_AND_rg_utip__ETC___d981;
  wire [3 : 0] x__h12043;
  wire [2 : 0] SEL_ARR_IF_v_trig_tdata1_0_2_BITS_19_TO_18_3_E_ETC___d126;
  wire NOT_rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_ETC___d933,
       ...
       r__h5780,
       rg_medeleg_u1_36_CONCAT_0_CONCAT_rg_medeleg_m2_ETC___d913,
       rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d909,
       rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d936,
       write_csr_addr_EQ_0x1_31_AND_NOT_fflags_91_EQ__ETC___d549,
       write_csr_addr_EQ_0x2_37_AND_NOT_frm_90_EQ_wri_ETC___d547,
       write_csr_word_BITS_1_TO_0_38_ULT_2___d439,
       x__h3526,
       x__h5545,
       x__h5579,
       x__h5607,
  ...
  begin
    case (read_csr_addr)
      12'h0: read_csr = data___1__h5775;
      12'h001: read_csr = data___1__h5510;
      12'h002: read_csr = data___1__h5505;
      12'h003: read_csr = data___1__h5498;
      12'h004: read_csr = data___1__h5671;
      12'h005: read_csr = data___1__h5666;
      12'h040: read_csr = rg_uscratch;
      12'h041: read_csr = data___1__h5657;
      12'h042: read_csr = data___1__h5646;
      12'h043: read_csr = rg_utval;
      12'h044: read_csr = data___1__h5531;
      12'h300: read_csr = data___1__h6663;
      12'h301:
	  read_csr =
	      { 11'd512,
		misa_u,
		...
		1'd0,
		misa_a };
      12'h302: read_csr = data___1__h6652;
      12'h303: read_csr = data___1__h6661;
      12'h304: read_csr = data___1__h6619;
      12'h305: read_csr = data___1__h6688;
      12'h306: read_csr = data___1__h6552;
      12'h323: read_csr = mhpmevent_0;
      12'h340: read_csr = rg_mscratch;
      12'h341: read_csr = data___1__h6572;
      12'h342: read_csr = data___1__h6558;
      12'h343: read_csr = rg_mtval;
      12'h344: read_csr = data___1__h6586;
      12'h3A0: read_csr = data___1__h6155;
      12'h3A1, 12'h3A2, 12'h3A3, 12'h7A8, 12'h800: read_csr = 32'd0;
      12'h3B0: read_csr = data___1__h6021;
      12'h3B1: read_csr = data___1__h6004;
      12'h3B2: read_csr = data___1__h5987;
      12'h3B3: read_csr = data___1__h5842;
      12'h7A0: read_csr = data___1__h5474;
      12'h7A1: read_csr = data___1__h4502;
      12'h7A2: read_csr = data___1__h4412;
      12'h7A3: read_csr = data___1__h4305;
      12'h7A4: read_csr = data___1__h4214;
  ...
  // actionvalue method upd_on_ret
  assign upd_on_ret =
	     { IF_upd_on_ret_prv_EQ_0_83_THEN_IF_misa_c_62_TH_ETC___d892,
	       1'b0 } ;
  ...
  assign upd_on_trap =
	     { rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d936 ?
		 IF_rg_umode_45_EQ_1_46_AND_upd_on_trap_cause_B_ETC___d950 :
		 IF_rg_mode_56_EQ_1_51_AND_upd_on_trap_cause_BI_ETC___d954,
	       2'b0 } ;
  ...
  // value method mv_interrupt
  assign mv_interrupt = x__h17955 != 12'd0 ;
  ...
  assign MUX_rg_mcause_write_1__SEL_2 =
	     EN_upd_on_trap &&
	     NOT_rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_ETC___d933 ;
  ...
  assign MUX_mhpmcounter_0_write_1__VAL_1 =
	     (write_csr_addr == 12'hB03) ? x__h7870 : x__h8054 ;
  assign MUX_mhpmcounter_0_write_1__VAL_2 =
	     mhpmcounter_0 + { 63'd0, x__h3526 } ;
  ...
  assign IF_rg_mode_56_EQ_1_51_AND_upd_on_trap_cause_BI_ETC___d954 =
	     (rg_mode == 2'd1 && upd_on_trap_cause[5]) ?
	       rg_mtvec + { 25'd0, upd_on_trap_cause[4:0] } :
	       rg_mtvec ;
  assign IF_rg_umode_45_EQ_1_46_AND_upd_on_trap_cause_B_ETC___d950 =
	     (rg_umode == 2'd1 && upd_on_trap_cause[5]) ?
	       rg_utvec + { 25'd0, upd_on_trap_cause[4:0] } :
	       rg_utvec ;
  assign IF_upd_on_ret_prv_EQ_0_83_THEN_IF_misa_c_62_TH_ETC___d892 =
	     (upd_on_ret_prv == 2'd0) ?
	       (misa_c ? rg_uepc : result__h12816) :
	       (misa_c ? rg_mepc : result__h12955) ;
  assign NOT_rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_ETC___d933 =
	     !rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d909 &&
	     !rg_medeleg_u1_36_CONCAT_0_CONCAT_rg_medeleg_m2_ETC___d913 ||
	     rg_prv != 2'd0 ||
	     !misa_n ;
  ...
  assign _0_CONCAT_rg_utie_52_AND_misa_n_15_AND_rg_utip__ETC___d981 =
	     { 2'd0,
	       rg_utie & misa_n_15_AND_rg_utip_19___d319,
	       rg_msie & rg_msip,
	       2'd0,
	       rg_usie & misa_n_15_AND_rg_usip_24___d320 } ;
  assign _theResult_____2__h3865 = read_csr ;
  assign bs__h3529 = { ma_events_e, 1'b0 } ;
  assign data___1__h4305 =
	     { 6'd0,
	       CASE_trigger_index_0_v_trig_tdata3_0_1_v_trig__ETC__q5,
	       25'd0 } ;
  assign data___1__h4502 =
	     CASE_trigger_index_0_v_trig_tdata1_0_BITS_19_T_ETC__q23 ?
	       { 4'd2,
		 CASE_trigger_index_0_v_trig_tdata1_0_BIT_0_1_v_ETC__q21,
		 _0_CONCAT_SEL_ARR_IF_v_trig_tdata1_0_2_BITS_19__ETC___d131 } :
	       IF_SEL_ARR_v_trig_tdata1_0_2_BITS_19_TO_18_3_E_ETC___d184 ;
  assign data___1__h5474 = { 31'd0, trigger_index } ;
  assign data___1__h5498 = { 24'd0, x__h5501 } ;
  assign data___1__h5505 = { 29'd0, frm } ;
  assign data___1__h5510 = { 27'd0, fflags } ;
  assign data___1__h5531 =
	     { 20'd0,
	       rg_meip,
	       2'd0,
	       x__h5545 & misa_n,
	       ...
	       2'd0,
	       x__h5607 & misa_n } ;
  assign data___1__h5646 = { rg_uinterrupt, 26'd0, rg_ucause } ;
  assign data___1__h5657 = { rg_uepc, 1'b0 } ;
  assign data___1__h5666 = { rg_utvec, rg_umode } ;
  assign data___1__h5671 =
	     { 20'd0,
	       rg_meie,
	       2'd0,
  ...
  assign data___1__h5775 =
	     { r__h5780,
	       ...
	       3'd0,
	       rg_uie } ;
  assign data___1__h5842 = { 2'd0, v_pmp_addr_3 } ;
  assign data___1__h5987 = { 2'd0, v_pmp_addr_2 } ;
  assign data___1__h6004 = { 2'd0, v_pmp_addr_1 } ;
  assign data___1__h6021 = { 2'd0, v_pmp_addr_0 } ;
  assign data___1__h6155 =
	     { v_pmp_cfg_3, v_pmp_cfg_2, v_pmp_cfg_1, v_pmp_cfg_0 } ;
  assign data___1__h6552 = { 29'd0, rg_mcounteren } ;
  assign data___1__h6558 = { rg_minterrupt, 26'd0, rg_mcause } ;
  assign data___1__h6572 = { rg_mepc, 1'b0 } ;
  assign data___1__h6586 =
	     { 20'd0,
	       rg_meip,
	       2'd0,
	       misa_n_15_AND_soft_ueip_11_OR_ext_ueip_12_13___d318,
  ...
  assign data___1__h6652 =
	     { 16'd0,
	       ...
	       2'd0,
	       rg_medeleg_l10 } ;
  assign data___1__h6661 = { 20'd0, rg_mideleg } ;
  assign data___1__h6663 = csr_mstatus ;
  assign data___1__h6688 = { rg_mtvec, rg_mode } ;
  assign instr__h17662 = { minstreth, minstret } ;
  assign instr__h17663 = instr__h17662 + 64'd1 ;
  assign mcycleh_CONCAT_mcycle_PLUS_1___d4 = new_cycle__h3327 + 64'd1 ;
  assign misa__h262 =
	     { 5'd0,
	       misa_u,
	       6'd16,
  ...
  assign misa_n_15_AND_soft_ueip_11_OR_ext_ueip_12_13___d318 =
	     misa_n & y__h5548 ;
  assign new_cycle__h3327 = { mcycleh, mcycle } ;
  assign r__h5780 = fs == 2'b11 ;
  assign result__h12816 = { rg_uepc[30:1], 1'd0 } ;
  assign result__h12955 = { rg_mepc[30:1], 1'd0 } ;
  assign rg_medeleg_u1_36_CONCAT_0_CONCAT_rg_medeleg_m2_ETC___d913 =
  ...
  assign rg_medeleg_u1_CONCAT_0_CONCAT_rg_medeleg_m2_CO_ETC__q7 =
	     ...
	     upd_on_trap_cause[4:0] ;
  assign rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d909 =
	     rg_mideleg_SRL_upd_on_trap_cause_BITS_4_TO_0__q6[0] &
	     upd_on_trap_cause[5] ;
  assign rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d936 =
	     (rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d909 ||
	      rg_medeleg_u1_36_CONCAT_0_CONCAT_rg_medeleg_m2_ETC___d913) &&
	     rg_prv == 2'd0 &&
	     misa_n ;
  ...
  assign rg_ueie_49_AND_misa_n_15_AND_soft_ueip_11_OR_e_ETC___d982 =
	     { rg_ueie & misa_n_15_AND_soft_ueip_11_OR_ext_ueip_12_13___d318,
	       rg_mtie & rg_mtip,
	       _0_CONCAT_rg_utie_52_AND_misa_n_15_AND_rg_utip__ETC___d981 } ;
  assign write_csr_addr_EQ_0x1_31_AND_NOT_fflags_91_EQ__ETC___d549 =
	     write_csr_addr == 12'h001 && fflags != write_csr_word[4:0] ||
	     write_csr_addr != 12'h001 &&
	     write_csr_addr_EQ_0x2_37_AND_NOT_frm_90_EQ_wri_ETC___d547 ;
  assign write_csr_addr_EQ_0x2_37_AND_NOT_frm_90_EQ_wri_ETC___d547 =
	     write_csr_addr == 12'h002 && frm != write_csr_word[2:0] ||
	     write_csr_addr == 12'h003 && x__h5501 != write_csr_word[7:0] ;
  assign write_csr_word_BITS_1_TO_0_38_ULT_2___d439 =
  ...
  assign x__h17955 =
	     { rg_meie & rg_meip,
	       2'd0,
	       rg_ueie_49_AND_misa_n_15_AND_soft_ueip_11_OR_e_ETC___d982 } ;
  assign x__h3526 = bs__h3529[mhpmevent_0[3:0]] ;
  assign x__h5501 = { frm, fflags } ;
  assign x__h5545 = rg_mideleg[8] & y__h5548 ;
  assign x__h5579 = rg_mideleg[4] & rg_utip ;
  assign x__h5607 = rg_mideleg[0] & rg_usip ;
  assign x__h7870 = { mhpmcounter_0[63:32], write_csr_word } ;
  assign x__h8054 = { write_csr_word, mhpmcounter_0[31:0] } ;
  assign y__h5548 = soft_ueip | ext_ueip ;
  ...
  begin
    case (trigger_index)
      1'd0: data___1__h4214 = v_tinfo_0;
      1'd1: data___1__h4214 = v_tinfo_1;
    endcase
  end
  ...
  begin
    case (trigger_index)
      1'd0: data___1__h4412 = v_trig_tdata2_0;
      1'd1: data___1__h4412 = v_trig_tdata2_1;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d893 = $test$plusargs("fullverbose");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d894 = $test$plusargs("mcsr");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d895 = $test$plusargs("l2");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap &&
	  (TASK_testplusargs___d893 ||
	   TASK_testplusargs___d894 && TASK_testplusargs___d895))
	$write("[%10d", v__h13078, "] ");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap &&
	  (TASK_testplusargs___d893 ||
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d900 = $test$plusargs("mcsr");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d901 = $test$plusargs("l2");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d916 = $test$plusargs("mcsr");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d917 = $test$plusargs("l2");
	  #0;
	end
    TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d923 =
	(TASK_testplusargs___d915 ||
	 TASK_testplusargs___d916 && TASK_testplusargs___d917) &&
	rg_prv == 2'd3;
    TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d925 =
	(TASK_testplusargs___d915 ||
	 TASK_testplusargs___d916 && TASK_testplusargs___d917) &&
	rg_prv != 2'd3;
    TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d934 =
	(TASK_testplusargs___d915 ||
	 TASK_testplusargs___d916 && TASK_testplusargs___d917) &&
	NOT_rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_ETC___d933;
    TASK_testplusargs_15_OR_TASK_testplusargs_16_A_ETC___d937 =
	(TASK_testplusargs___d915 ||
	 TASK_testplusargs___d916 && TASK_testplusargs___d917) &&
	rg_mideleg_09_SRL_upd_on_trap_cause_BITS_4_TO__ETC___d936;
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d939 = $test$plusargs("mcsr");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
	begin
	  TASK_testplusargs___d940 = $test$plusargs("l2");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_upd_on_trap)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_csr)
	begin
	  TASK_testplusargs___d421 = $test$plusargs("mcsr");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_csr)
