...
module mkrestoring_div(CLK,
  ...
  input  [31 : 0] get_inputs_op1;
  input  [31 : 0] get_inputs_op2;
  input  get_inputs_qr;
  input  EN_get_inputs;
  ...
  wire [64 : 0] x__h326;
  wire [31 : 0] x_BITS_31_TO_0___h327;
  ...
  // value method quo_rem
  assign quo_rem = quotient_remainder ? partial[63:32] : partial[31:0] ;
  ...
  // inputs to muxes for submodule ports
  assign MUX_partial_write_1__VAL_1 = { 33'd0, get_inputs_op1 } ;
  module_singlestep instance_singlestep_0(.singlestep_remainder(x__h326[64:32]),
					  .singlestep_quotient(x_BITS_31_TO_0___h327),
  ...
  // remaining internal signals
  assign x_BITS_31_TO_0___h327 = partial[31:0] ;
