...
//
// On Wed Apr  2 00:04:26 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mkeclass_axi4lite(resetpc,
  ...
  reg [63 : 0] v__h7357;
  reg riscv_memory_request_get_7_BITS_5_TO_4_00_EQ_1_ETC___d138;
  reg riscv_memory_request_get_7_BITS_5_TO_4_00_EQ_1_ETC___d146;
  reg NOT_riscv_memory_request_get_7_BITS_5_TO_4_00__ETC___d156;
  ...
  reg TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d200;
  reg TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d202;
  reg TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d204;
  reg TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d209;
  reg TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d225;
  reg TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d227;
  reg TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d229;
  reg TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d234;
  // synopsys translate_on

  // remaining internal signals
  reg [31 : 0] CASE_ff_mem_requestD_OUT_BITS_2_TO_1_0_IF_ff__ETC__q3,
	       w_wdata__h5117;
  reg [3 : 0] write_strobe__h3876;
  wire [31 : 0] lv_data__h3443,
		memory_xactor_f_rd_data_first__68_BITS_31_TO_0_ETC___d177,
		pmpreq_address__h1876,
		pmpreq_address__h3905,
		put_data__h6675,
		put_data__h7259,
		put_inst__h3466,
		read_request_araddr__h4812;
  ...
  wire [5 : 0] pmpreq_num_bytes__h3906;
  wire [4 : 0] lv_shift__h3442, lv_shift__h6654;
  wire [3 : 0] w_wstrb__h5118, write_strobe___1__h6181;
  wire [2 : 0] read_request_arprot__h2993;
  wire [1 : 0] pmpreq_access_type__h3907;
  wire rg_wEpoch_port1__read__6_EQ_riscv_memory_reque_ETC___d99,
       x_port1__read__h3891;
  ...
  // submodule memory_xactor_f_wr_data
  assign memory_xactor_f_wr_data_D_IN = { w_wdata__h5117, w_wstrb__h5118 } ;
  ...
  // remaining internal signals
  module_fn_pmp_lookup instance_fn_pmp_lookup_1(.fn_pmp_lookup_req({ pmpreq_address__h1876,
								     8'd18 }),
  ...
  module_fn_pmp_lookup instance_fn_pmp_lookup_0(.fn_pmp_lookup_req({ pmpreq_address__h3905,
								     pmpreq_num_bytes__h3906,
								     pmpreq_access_type__h3907 }),
						.fn_pmp_lookup_priv(riscv_mv_curr_priv),
						.fn_pmp_lookup_pmpcfg(riscv_mv_pmp_cfg),
						.fn_pmp_lookup_pmpaddr(riscv_mv_pmp_addr),
						.fn_pmp_lookup(fn_pmp_lookup___d109));
  assign lv_data__h3443 =
	     fetch_xactor_f_rd_data_D_OUT[31:0] >> lv_shift__h3442 ;
  assign lv_shift__h3442 = { ff_inst_request_D_OUT[3:2], 3'd0 } ;
  assign lv_shift__h6654 = { ff_mem_request_D_OUT[39:38], 3'd0 } ;
  assign memory_xactor_f_rd_data_first__68_BITS_31_TO_0_ETC___d177 =
	     memory_xactor_f_rd_data_D_OUT[31:0] >> lv_shift__h6654 ;
  ...
  assign pmpreq_access_type__h3907 =
	     (riscv_memory_request_get[5:4] == 2'd0) ?
	       riscv_memory_request_get[5:4] :
	       2'd1 ;
  assign pmpreq_address__h1876 = riscv_inst_request_get[33:2] ;
  assign pmpreq_address__h3905 = riscv_memory_request_get[69:38] ;
  assign pmpreq_num_bytes__h3906 = { 4'd0, riscv_memory_request_get[2:1] } ;
  assign put_data__h6675 =
	     (memory_xactor_f_rd_data_D_OUT[33:32] == 2'd0) ?
	       CASE_ff_mem_requestD_OUT_BITS_2_TO_1_0_IF_ff__ETC__q3 :
	       ff_mem_request_D_OUT[69:38] ;
  assign put_data__h7259 =
	     (memory_xactor_f_wr_resp_D_OUT == 2'd0) ?
	       32'd0 :
	       ff_mem_request_D_OUT[69:38] ;
  assign put_inst__h3466 =
	     (fetch_xactor_f_rd_data_D_OUT[33:32] == 2'd0) ?
	       lv_data__h3443 :
	       ff_inst_request_D_OUT[33:2] ;
  assign read_request_araddr__h4812 =
	     fn_pmp_lookup___d109[6] ?
	       32'd0 :
	       riscv_memory_request_get[69:38] ;
  assign read_request_arprot__h2993 = { 2'd0, riscv_mv_curr_priv[1] } ;
  assign rg_wEpoch_port1__read__6_EQ_riscv_memory_reque_ETC___d99 =
	     x_port1__read__h3891 == riscv_memory_request_get[0] ;
  assign w_wstrb__h5118 =
	     (riscv_memory_request_get[3:1] == 3'd3) ?
	       write_strobe__h3876 :
	       write_strobe___1__h6181 ;
  assign write_strobe___1__h6181 =
	     write_strobe__h3876 << riscv_memory_request_get[39:38] ;
  assign x_port1__read__h3891 = riscv_mv_trap ? ~rg_wEpoch : rg_wEpoch ;
  always@(riscv_memory_request_get)
  begin
    case (riscv_memory_request_get[2:1])
      2'd0: w_wdata__h5117 = {4{riscv_memory_request_get[13:6]}};
      2'd1: w_wdata__h5117 = {2{riscv_memory_request_get[21:6]}};
      default: w_wdata__h5117 = riscv_memory_request_get[37:6];
    endcase
  end
  always@(riscv_memory_request_get)
  begin
    case (riscv_memory_request_get[3:1])
      3'd0: write_strobe__h3876 = 4'b0001;
      3'd1: write_strobe__h3876 = 4'b0011;
      default: write_strobe__h3876 = 4'hF;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_fetch_request &&
	  NOT_fn_pmp_lookup_7_BIT_6_8_7_AND_TASK_testplu_ETC___d36)
	$write("'h%h", read_request_arprot__h2993);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_fetch_request &&
	  NOT_fn_pmp_lookup_7_BIT_6_8_7_AND_TASK_testplu_ETC___d36)
	$write(", ", "arsize: ");
    ...
    riscv_memory_request_get_7_BITS_5_TO_4_00_EQ_1_ETC___d138 =
	riscv_memory_request_get[5:4] == 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_wEpoch_port1__read__6_EQ_riscv_memory_reque_ETC___d99 &&
	  riscv_memory_request_get_7_BITS_5_TO_4_00_EQ_1_ETC___d138)
	$write("'h%h", read_request_araddr__h4812);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_memory_request &&
	  rg_wEpoch_port1__read__6_EQ_riscv_memory_reque_ETC___d99 &&
	  riscv_memory_request_get_7_BITS_5_TO_4_00_EQ_1_ETC___d138)
    ...
    riscv_memory_request_get_7_BITS_5_TO_4_00_EQ_1_ETC___d146 =
	riscv_memory_request_get[5:4] == 2'd1 &&
    ...
    NOT_riscv_memory_request_get_7_BITS_5_TO_4_00__ETC___d156 =
	riscv_memory_request_get[5:4] != 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_memoryRead_response)
	begin
	  TASK_testplusargs___d195 = $test$plusargs("meclass");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_memoryRead_response)
    ...
    TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d200 =
	(TASK_testplusargs___d194 ||
	 TASK_testplusargs___d195 && TASK_testplusargs___d196) &&
	memory_xactor_f_rd_data_D_OUT[33:32] == 2'd0;
    TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d202 =
	(TASK_testplusargs___d194 ||
	 TASK_testplusargs___d195 && TASK_testplusargs___d196) &&
	memory_xactor_f_rd_data_D_OUT[33:32] == 2'd1;
    TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d204 =
	(TASK_testplusargs___d194 ||
	 TASK_testplusargs___d195 && TASK_testplusargs___d196) &&
	memory_xactor_f_rd_data_D_OUT[33:32] == 2'd2;
    TASK_testplusargs_94_OR_TASK_testplusargs_95_A_ETC___d209 =
	(TASK_testplusargs___d194 ||
	 TASK_testplusargs___d195 && TASK_testplusargs___d196) &&
	memory_xactor_f_rd_data_D_OUT[33:32] != 2'd0 &&
	memory_xactor_f_rd_data_D_OUT[33:32] != 2'd1 &&
	...
	begin
	  TASK_testplusargs___d219 = $test$plusargs("fullverbose");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_memoryWrite_response)
	begin
	  TASK_testplusargs___d220 = $test$plusargs("meclass");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_handle_memoryWrite_response)
	begin
	  TASK_testplusargs___d221 = $test$plusargs("l0");
	  #0;
	end
    TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d225 =
	(TASK_testplusargs___d219 ||
	 TASK_testplusargs___d220 && TASK_testplusargs___d221) &&
	memory_xactor_f_wr_resp_D_OUT == 2'd0;
    TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d227 =
	(TASK_testplusargs___d219 ||
	 TASK_testplusargs___d220 && TASK_testplusargs___d221) &&
	memory_xactor_f_wr_resp_D_OUT == 2'd1;
    TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d229 =
	(TASK_testplusargs___d219 ||
	 TASK_testplusargs___d220 && TASK_testplusargs___d221) &&
	memory_xactor_f_wr_resp_D_OUT == 2'd2;
    TASK_testplusargs_19_OR_TASK_testplusargs_20_A_ETC___d234 =
	(TASK_testplusargs___d219 ||
	 TASK_testplusargs___d220 && TASK_testplusargs___d221) &&
	memory_xactor_f_wr_resp_D_OUT != 2'd0 &&
	memory_xactor_f_wr_resp_D_OUT != 2'd1 &&
