...
module mksign_dump_axi4lite(CLK,
  ...
  FIFO2 #(.width(32'd37), .guarded(1'd1)) m_xactor_f_rd_addr(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd66), .guarded(1'd1)) m_xactor_f_rd_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd37), .guarded(1'd1)) m_xactor_f_wr_addr(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd72), .guarded(1'd1)) m_xactor_f_wr_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd2), .guarded(1'd1)) m_xactor_f_wr_resp(.RST(RST_N),
							    .CLK(CLK),
  ...
  FIFO2 #(.width(32'd66), .guarded(1'd1)) s_xactor_f_rd_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd72), .guarded(1'd1)) s_xactor_f_wr_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  // remaining internal signals
  assign lv_shift__h2669 = { ff_lower_order_bits_D_OUT, 3'd0 } ;
  assign m_xactor_f_rd_dataD_OUT_BITS_63_TO_0_SRL_lv_s_ETC__q2 =
	     m_xactor_f_rd_data_D_OUT[63:0] >> lv_shift__h2669 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[65:64] != 2'd0)
	$display(v__h2949, "\tSIGNATUREDUMP got Bus Error");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[65:64] != 2'd0)
	$finish(32'd0);
