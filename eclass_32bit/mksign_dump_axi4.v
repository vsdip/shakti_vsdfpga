...
//
// On Mon Mar 31 00:26:00 IST 2025
//
//
// Ports:
// Name                         I/O  size props
...
module mksign_dump_axi4(CLK,
  ...
  wire [38 : 0] m_xactor_f_rd_data_D_IN, m_xactor_f_rd_data_D_OUT;
  ...
  wire [40 : 0] m_xactor_f_wr_data_D_IN, m_xactor_f_wr_data_D_OUT;
  ...
  wire [38 : 0] s_xactor_f_rd_data_D_IN, s_xactor_f_rd_data_D_OUT;
  ...
  wire [40 : 0] s_xactor_f_wr_data_D_IN, s_xactor_f_wr_data_D_OUT;
  ...
  wire [31 : 0] s_xactor_f_wr_dataD_OUT_BITS_40_TO_9_MINUS_rg_ETC__q1;
  wire [4 : 0] lv_shift__h2825;
  ...
  // value method master_m_wdata
  assign master_WDATA = m_xactor_f_wr_data_D_OUT[40:9] ;

  // value method master_m_wstrb
  assign master_WSTRB = m_xactor_f_wr_data_D_OUT[8:5] ;
  ...
  // value method slave_m_rresp
  assign slave_RRESP = s_xactor_f_rd_data_D_OUT[38:37] ;

  // value method slave_m_rdata
  assign slave_RDATA = s_xactor_f_rd_data_D_OUT[36:5] ;
  ...
  FIFO2 #(.width(32'd39), .guarded(1'd1)) m_xactor_f_rd_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd41), .guarded(1'd1)) m_xactor_f_wr_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd39), .guarded(1'd1)) s_xactor_f_rd_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd41), .guarded(1'd1)) s_xactor_f_wr_data(.RST(RST_N),
							     .CLK(CLK),
  ...
  assign MUX_rg_start_write_1__SEL_1 =
	     ...
	     rg_start_address != s_xactor_f_wr_data_D_OUT[40:9] ;
  ...
  assign MUX_rg_total_count_write_1__VAL_1 =
	     { 2'd0,
	       s_xactor_f_wr_dataD_OUT_BITS_40_TO_9_MINUS_rg_ETC__q1[31:2] } ;
  ...
  // register rg_end_address
  assign rg_end_address_D_IN = s_xactor_f_wr_data_D_OUT[40:9] ;
  ...
  // submodule m_xactor_f_rd_addr
  assign m_xactor_f_rd_addr_D_IN = { rg_start_address, 20'd163858 } ;
  ...
  // submodule m_xactor_f_wr_data
  assign m_xactor_f_wr_data_D_IN = 41'h0 ;
  ...
  // submodule s_xactor_f_rd_data
  assign s_xactor_f_rd_data_D_IN = 39'h0 ;
  ...
  // remaining internal signals
  assign lv_shift__h2825 = { ff_lower_order_bits_D_OUT, 3'd0 } ;
  assign rg_cnt_ULT_5___d2 = rg_cnt < 5'd5 ;
  assign rg_start_address_0_ULT_rg_end_address_6___d37 =
	     rg_start_address < rg_end_address ;
  assign s_xactor_f_wr_dataD_OUT_BITS_40_TO_9_MINUS_rg_ETC__q1 =
	     s_xactor_f_wr_data_D_OUT[40:9] - rg_start_address ;
  ...
  begin
	...
	$fwrite(dump,
		"%4h\n",
		m_xactor_f_rd_data_D_OUT[36:5] >> lv_shift__h2825);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[38:37] != 2'd0)
	begin
	  v__h3105 = $time;
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[38:37] != 2'd0)
	$display(v__h3105, "\tSIGNATUREDUMP got Bus Error");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_receive_response &&
	  m_xactor_f_rd_data_D_OUT[38:37] != 2'd0)
	$finish(32'd0);
